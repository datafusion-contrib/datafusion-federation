...
## [0.5.7](https://github.com/datafusion-contrib/datafusion-federation/compare/v0.5.6...v0.5.7) - 2026-09-22

### Other

- Don't force datafusion's default features on consumers ([#184](https://github.com/datafusion-contrib/datafusion-federation/pull/184))
...
- add federation pushdown integration tests ([#178](https://github.com/datafusion-contrib/datafusion-federation/pull/178))

## [0.5.4](https://github.com/datafusion-contrib/datafusion-federation/compare/v0.5.3...v0.5.4) - 2026-07-02

### Other

- Upgrade to DataFusion v54 ([#176](https://github.com/datafusion-contrib/datafusion-federation/pull/176))
